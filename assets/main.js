...
var Commands = function (hostline, user, group) {
	...
	var softLink = function (user, group, source, target) {
		return 'lrwxrwxrwx   1 ' + utils.formatSpaces(user, 5) + ' ' + utils.formatSpaces(group, 5) + ' 4.0K Mar 29  22:09 ' +
	...
	return {
		...
		'ls_home': {
			...
			output: 'drwx------ 113 ' + utils.formatSpaces(user, 5) + ' ' + utils.formatSpaces(group, 5) + ' 4.0K Jul 24  17:00 .\n' +
				...
				file(user, group, 'resume.pdf', 'https://github.com/vladdoster/slice-of-internet/raw/master/assets/resume.pdf')
		},
		'dd_partition': {
